...
PRO starfinder_analyze, list, this_max, image, siz, background, stars, $ 
  ...
  ; a='' 
  ; read,a 
  ; print,this_max,n_elements(list) 
end 
...
PRO smart_starfinder, $ 
    image,initial_x,initial_y,initial_f0,psf, SV_PAR = sv_par, $ 
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; 
    ...
    ;  n_presumed = n_presumed + n_max 
       n_presumed=n_elements(initial_f0) 
      
 
 
    ; Phase 1: analyze presumed stars with correlation and fitting, 
    ...
    ;if  n_max ne 0  then begin 
     ...
     list_of_stars = starlist(n_presumed, initial_x, initial_y, initial_f0) 
    ...
    ; print,list_of_stars
     ...
     ;  for  n = 141L, 143L  do $ 
      ...
      ;star_flag=intarr(list_of_star) 
      ;for i=0L,n_elements(list_of_stars)-1L do begin 
     
       star_flag=list_of_stars.is_a_star     
       list_of_stars.is_a_star=1 
      ;endfor 
      
       list_of_stars = sort_list(extract_stars(list_of_stars, n_stars)) 
      
      
      print,n_elements(list_of_stars) 
     ; print,list_of_stars
    ...
    ;Phase 2:re-determination of positions and fluxes by iterative 
