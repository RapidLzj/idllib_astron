PRO ERR_PLOT, X, YLOW, YHIGH, WIDTH=WIDTH,color=color, $
...
for index = 0L, n_elements(x) - 1L do begin
  ...
  plots, xdata, ydata, /data, noclip=0,color=color, $
    _extra=extar_keywords
  ...
  plots, xdata, ylower, /normal, noclip=0,color=color, $
    _extra=extar_keywords
  plots, xdata, yupper, /normal, noclip=0,color=color, $
    _extra=extar_keywords
